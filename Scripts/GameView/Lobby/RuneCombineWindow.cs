...
namespace BlGame.View
{
    ...
    public class RuneCombineWindow : BaseWindow
    {
        ...
        GameObject m_CostGO;
        UILabel m_CostLabel;
        public Dictionary<string, SlotInfo> slot2RuneGoDict = new Dictionary<string, SlotInfo>();   // 장비槽上对应的장비
        public Dictionary<uint, nowAllRuneGOCache> nowAllRuneGO = new Dictionary<uint, nowAllRuneGOCache>();//当前등급存在的所有장비!등급不符合的全部删除！！
        public Dictionary<uint, int> runeOnTempSlotDic = new Dictionary<uint, int>();//暂시装在장비槽的장비
