...
namespace BlGame.View
{
    public class RuneRefreshWindow : BaseWindow
    {
        ...
        public Dictionary<uint, RefreshCardInfo> refreshCardListID2GoDict = new Dictionary<uint, RefreshCardInfo>();//所有장비！
        public Dictionary<uint, nowAllRuneGOCache> nowAllRuneGO = new Dictionary<uint, nowAllRuneGOCache>();//当前등급存在的所有장비!등급不
        ...
        public void onClickWash()
        {
            ...
            string showStr = GameDefine.GameConstDefine.showWashMsg + needgold.ToString() + "개의 동전";
        ...
        public void onClickLevel(GameObject go)
        {
            ...
            {
                m_PopList_Label.text = "등급" + go.name;
