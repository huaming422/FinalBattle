...
namespace BlGame.View
{
    public class PresonInfoWindow : BaseWindow
    {
        ...
        {
            if (string.Compare(mNewTemp.value.Trim(), "새별호입력") == 0 || string.Compare(mNewTemp.value.Trim(), "새별호입력") == 0)
                return;
        ...
        public override void OnEnable()
        {
            ...
            VIPLevelUp.text = /*"再累积" + (vipLevelInfo.VipIntegral - vipintegral) + "积분VIP" +vipLevel*/"";
