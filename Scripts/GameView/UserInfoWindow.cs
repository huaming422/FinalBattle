...
namespace BlGame.View
{
    public class UserInfoWindow : BaseWindow
    {
        ...
        protected override void InitWidget()
        {
            ...
            /*
             * 当用户在选择了英雄的情况下，再去选择男女英雄시，清除之前的选中状态
             * 
            */
        ...
        private const string invalideName = "승인되지않은 별호입니다";

        private const string collisionName = "같은별호가 이미 존재합니다";

        private const string nullName = "반드시 입력할것";
