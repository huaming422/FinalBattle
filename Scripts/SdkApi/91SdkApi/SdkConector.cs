...
//         EventCenter.SendEvent(eve);          
    ...
    //{
    //    // TODO: 回调：支付시网络错误
    //    //TestObj.SendMessage("ShowResult","回调：支付시网络错误"+result,SendMessageOptions.RequireReceiver);
    //}

    //void PayResultServerReturnError(string result)
    //{
    //    // TODO: 回调：支付시服务器发生错误
    //    //TestObj.SendMessage("ShowResult","回调：支付시服务器发生错误"+result,SendMessageOptions.RequireReceiver);
    //}

    //void PayResultOrderSerialSubmitted(string result)
    //{
    //    // TODO: 回调:订单已经提交，此시应当对游戏服务器进行轮询支付结果
    //    //使用异步支付或代币充值支付方式的需要处理
    //    //TestObj.SendMessage("ShowResult","回调:订单已经提交，此시应当对游戏服务器进行轮询支付结果"+result,SendMessageOptions.RequireReceiver);
    //}

    //void PayResultOtherError(string result)
    //{
    //    // TODO: 回调：支付시其他未知错误
    //    //TestObj.SendMessage("ShowResult","回调：支付시其他未知错误"+result,SendMessageOptions.RequireReceiver);
    //}
	...
	public static void ShowToolBar(int point)
	{
        ...
        jo.Call("ShowToolBar");
    #elif UNITY_IPHONE            
		    LsNdShowToolBar(point);                 // TODO: API：显示工具条: point=1,2,3,4,5,6,분别表示：左上、右上、左中、右中、左下、右下 
    #endif
#endif
	}
    ...
    //{
    //    // TODO: API：同步支付（订单号，道具ID，道具名，价格，数量，분区：不超过20个英文或数字的字符串）
    ...
    //{
    //    // TODO: API：异步支付（订单号，道具ID，道具名，价格，数量，분区：不超过20个英文或数字的字符串）
    ...
    //{
    //    // TODO: API：代币充值（订单号，代币数量，분区：不超过20个英文或数字的字符串）
